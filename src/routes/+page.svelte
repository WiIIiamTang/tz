...
<div class="px-4 my-4 w-full">
	<div class="w-1/2">
		...
		<h1 class="font-bold text-2xl px-4 py-2 w-fit rounded-full">
			America/Vancouver: {dayjsnow.tz('America/Vancouver').format('HH:mm:ss')}
		</h1>
		<h1 class="font-bold text-2xl px-4 py-2 w-fit rounded-full">
			Asia/Kolkata: {dayjsnow.tz('Asia/Kolkata').format('HH:mm:ss')}
		</h1>
		<h1 class="font-bold text-2xl px-4 py-2 w-fit rounded-full">
			Australia/Sydney: {dayjsnow.tz('Australia/Sydney').format('HH:mm:ss')}
		</h1>
		<h1 class="font-bold text-2xl px-4 py-2 w-fit rounded-full">
			Europe/Dublin: {dayjsnow.tz('Europe/Dublin').format('HH:mm:ss')}
		</h1>
	</div>
</div>
